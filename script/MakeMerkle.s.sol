 ...
 * @author Cyfrin & Ciara Nightingale
 *
 * Original Work by:
 * @author kootsZhin
...
contract MakeMerkle is Script, ScriptHelper {
    ...
    Merkle private m = new Merkle(); // instance of the merkle contract from Murky to do stuff
    ...
    string[] private types = elements.readStringArray(".types"); // gets the merkle tree leaf types from json using forge std lib cheatcode
    ...
    function run() public {
        ...
        for (uint256 i = 0; i < count; ++i) {
            ...
            // hash again because merkle stuff says so (ask Patrick)
